...
import { Search, Car, User, Calendar, ArrowRight, Loader2, AlertTriangle, RefreshCw } from "lucide-react";
...
export default function HandoverList() {
  ...
  const fetchBookings = useCallback(async () => {
    ...
    setError(null);
    try {
      // Lấy booking trạng thái CONFIRMED — ready to hand over
      const res = await getAllBookingsApi("CONFIRMED", 0, 50);
  ...
  const filtered = bookings.filter((b) => {
    ...
    const text = `${b.id} ${b.bookingCode || ""} ${b.userId || ""} ${unitText} ${b.deliveryAddress || ""}`.toLowerCase();
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">Danh sách các đơn đã xác nhận, sẵn sàng bàn giao xe.</p>
        </div>
        <button
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full text-xs font-medium border border-blue-100">✅ Đã xác nhận</span>
                    </div>
                  ...
                  <button
                    ...
                    className="ml-4 flex items-center gap-2 bg-blue-600 text-white px-5 py-2.5 rounded-xl hover:bg-blue-700 transition font-medium shadow-sm whitespace-nowrap"
                  >
